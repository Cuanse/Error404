...
create TRIGGER after_delete_usuario
	...
	values(
		...
		CONCAT("INSERT INTO USUARIO (ID_USUARIO, ID_PERFIL, PASSWORD, NOMBREUSUARIO, ESADMIN, ESACTIVO, CARRERA, CREADO) VALUES (",OLD.ID_USUARIO,",",OLD.ID_PERFIL,",""",OLD.PASSWORD,""",""",OLD.NOMBREUSUARIO,""",",OLD.ESADMIN,",",OLD.ESACTIVO,",""",OLD.CARRERA,""",""",OLD.CREADO,""");")
	);
...
create TRIGGER after_update_usuario
	...
	values(
		now(),"USUARIO",
		CONCAT("UPDATE POST set  ID_PERFIL=",NEW.ID_PERFIL,",PASSWORD=""",NEW.PASSWORD,""",NOMBREUSUARIO=""",NEW.NOMBREUSUARIO,""",ESADMIN=",NEW.ESADMIN,",ESACTIVO=",NEW.ESACTIVO,",CARRERA=""",NEW.CARRERA,""",CREADO=""",NEW.CREADO,""" where ID_USUARIO = ",NEW.ID_USUARIO,";"),
		CONCAT("UPDATE POST set  ID_PERFIL=",OLD.ID_PERFIL,",PASSWORD=""",OLD.PASSWORD,""",NOMBREUSUARIO=""",OLD.NOMBREUSUARIO,""",ESADMIN=",OLD.ESADMIN,",ESACTIVO=",OLD.ESACTIVO,",CARRERA=""",OLD.CARRERA,""",CREADO=""",OLD.CREADO,""" where ID_USUARIO = ",OLD.ID_USUARIO,";")
	);    
...
create TRIGGER after_insert_perfil
	...
	values(
		now(),"PERFIL",
		CONCAT("INSERT INTO PERFIL(ID_PERFIL, ID_PAIS, CUMPLEANOS, GENERO, BIOGRAFIA, TELEFONO, DIRECCION, EMAILPUBLICO) VALUES (",NEW.ID_PERFIL,",""",NEW.ID_PAIS,""",""",NEW.CUMPLEANOS,""",""",NEW.GENERO,""",""",NEW.BIOGRAFIA,""",""",NEW.TELEFONO,""",""",NEW.DIRECCION,""",""",NEW.EMAILPUBLICO,""");"),
